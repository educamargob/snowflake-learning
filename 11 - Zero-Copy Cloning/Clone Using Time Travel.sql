...
// Using time travel
SELECT * FROM OUR_FIRST_DB.public.time_travel at (OFFSET => -60*1.5);
...
SELECT * FROM OUR_FIRST_DB.public.time_travel_clone before (statement => '01bf2532-0001-0372-0000-b3b1000a7132');

CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone_of_clone
CLONE OUR_FIRST_DB.public.time_travel_clone before (statement => '01bf2532-0001-0372-0000-b3b1000a7132');
